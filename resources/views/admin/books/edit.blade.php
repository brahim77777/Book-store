                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <select id="category" class="form-control" name="category">
                                <option disabled {{$book->categry == null ? 'selected' : '' }}>اختر تصنيفًا</option>
                                @foreach($categories as $categry)
                                    <option  {{$book->categry == $categry ? 'selected' : '' }} value="{{ $categry->id }}">{{ $categry->name }}</option>
                                @endforeach
                            </select>
                            @error('category')
                            <span class="invalid-feedback" role="alert">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <select id="publisher" class="form-control" name="publisher">
                                <option disabled {{$book->publisher ? '' : 'selected' }}>اختر ناشرًا</option>
